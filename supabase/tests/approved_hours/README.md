# Approved hours — migration 137 DB harness

Executable verification for `supabase/migrations/137_shift_approved_minutes.sql`: the
...
137 file verbatim, then the assertions. It never contacts a hosted database and reads no `.env*`.
