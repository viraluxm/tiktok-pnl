    ...
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="max-w-3xl mx-auto grid md:grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-8">
          <p className="text-sm font-semibold text-gray-400 uppercase tracking-wide mb-2">Additional Shops</p>
          <div className="mb-1">
            <span className="text-5xl font-extrabold text-white">${extraShopPrice}</span>
            <span className="text-gray-500 ml-1">/shop/month</span>
          </div>
          <p className="text-xs text-gray-500 mb-6">Add as many shops as you need</p>

          <ul className="text-left space-y-3 mb-8">
            {[
              'Connect multiple TikTok Shops',
              ...
              <li key={i} className="flex items-center gap-3 text-gray-300 text-sm">
                <svg className="w-4.5 h-4.5 text-gray-500 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <polyline points="20 6 9 17 4 12"/>
                </svg>
                {item}
              </li>
          ...
          <Link
            href="/signup"
            className="block w-full px-8 py-3.5 text-base font-semibold text-gray-300 bg-white/[0.06] border border-white/10 rounded-xl hover:bg-white/10 transition-all text-center"
          >
            Get Started
          </Link>
        </div>
