...
export default function DemoHeader({ onExportCSV, onImportCSV, onClearAll }: DemoHeaderProps) {
  ...
  return (
    <div className="flex items-center justify-between px-6 py-4 border-b border-tt-border bg-[rgba(15,15,15,0.95)] backdrop-blur-xl sticky top-0 z-50">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-tt-muted text-xs ml-2 hidden sm:inline">{DEMO_USER_EMAIL}</span>
