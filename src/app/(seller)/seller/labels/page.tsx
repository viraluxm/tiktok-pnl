...
// /seller/labels — the seller buys and prints labels for their OWN orders.
//
...
// from a parameter it is handed. A seller therefore sees only their own boxes and buys only their
// own labels, with no seller-specific branch anywhere in the flow.
//
